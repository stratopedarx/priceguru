...
from ..forms.loginza_form import CompleteReg
...
def loginza_auth_handler(sender, user, identity, **kwargs):
    try:
        ...
        return redirect(reverse('user:users_complete_registration'))
...
def complete_registration(request):
    ...
    return render_to_response('user/loginza_complete_reg.html',
                              {'form': form},
